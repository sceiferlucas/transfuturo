...
session_start();
	...
	if (isset($_POST['enviar'])) {
		...
		$insert = "INSERT INTO tabela_box5 (mecanico, ordem, data, hora, placa, servico, previsao, obs) VALUES (:mecanico, :ordem, :data, :hora, :placa, :servico, :previsao, :observacoes)";
...
?>
	...
	<div id="formulario">
		...
		<div id="centro">Formulário Box 5</div>
		<div id="inputs">
