...
session_start();
	...
	if (isset($_POST['enviar'])) {
		...
		$insert = "INSERT INTO tabela_box19 (mecanico, ordem, data, hora, placa, servico, previsao, obs) VALUES (:mecanico, :ordem, :data, :hora, :placa, :servico, :previsao, :observacoes)";
...
?>
	...
	<div id="formulario">
		...
		<div id="centro">Formulário Box 19</div>
		<div id="inputs">
