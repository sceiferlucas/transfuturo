...
session_start();
	...
	$insert = "INSERT INTO tabela_box12 (mecanico, ordem, data, hora, placa, servico, previsao, obs) VALUES (:mecanico, :ordem, :data, :hora, :placa, :servico, :previsao, :observacoes)";
...
?>
	...
	<div id="formulario">
		...
		<div id="centro">Formulário Box 12</div>
		<div id="inputs">
