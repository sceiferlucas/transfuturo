...
session_start();
	...
	$insert = "INSERT INTO tabela_box21 (mecanico, ordem, data, hora, placa, servico, previsao, obs) VALUES (:mecanico, :ordem, :data, :hora, :placa, :servico, :previsao, :observacoes)";
...
?>
	...
	<div id="formulario">
		...
		<div id="centro">Formulário Box 21</div>
		<div id="inputs">
